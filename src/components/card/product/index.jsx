...
import { addToFavorite } from "../../../redux/slice/favorite-products";
...
const ProductCard = (product) => {
  ...
  return (
    <div className="product-card">
      <button className="product-card__favorite" onClick={() => dispatch(addToFavorite(product))}>
        {!isInFavorite ? (
          <GoHeart className="product-card__favorite-icon" />
        ) : (
          <GoHeartFill className="product-card__favorite-icon" />
        )}
      </button>
      ...
      <div className="product-rating">
        ...
        <span>
          {" "}
          {rating.toFixed(1)} ({product.reviews.length} comments)
        </span>
      </div>
      ...
      <div className="product-card__control">
        ...
        {!isInCart ? (
          <button className="product-card__btn" onClick={() => dispatch(addToCart(product))}>
